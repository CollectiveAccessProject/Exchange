module MediaPluginModel
  ...
  def preview(version, width=nil, height=nil, caption=nil, links=true, zoom=false)
    unless self.id
    ...
    action_view.render(
      ...
      locals: { plugin_model: self, version: version, width: width, height: height, caption: caption, links: links, zoom: zoom}
    )
  end
