  ...
  private def setup(options=nil)
    ...
    case
      ...
      when (@type == 'exhibition')
        ...
        @resources = res[:resources]
        @resources_needs_paging = @resources.respond_to?(:total_entries) ? (@resources.total_entries > WillPaginate.per_page) : false
        @resources_num_pages = @resources_needs_paging ? (@resources.total_entries / WillPaginate.per_page.to_f).ceil : 1
        ...
        @collections = res[:collections]
        @collections_needs_paging = @collections.respond_to?(:total_entries) ? (@collections.total_entries > WillPaginate.per_page) : false
        @collections_num_pages = @collections_needs_paging ? (@collections.total_entries / WillPaginate.per_page.to_f).ceil : 1
        ...
        @collection_objects = res[:collection_objects]
        @collection_objects_needs_paging = @collection_objects.respond_to?(:total_entries) ? (@collection_objects.total_entries > WillPaginate.per_page) : false
        @collection_objects_num_pages = @collection_objects_needs_paging ? (@collection_objects.total_entries / WillPaginate.per_page.to_f).ceil : 1
        ...
        @exhibitions = res[:exhibitions]
        @exhibitions_needs_paging = @exhibitions.respond_to?(:total_entries) ?  (@exhibitions.total_entries > WillPaginate.per_page) : false
        @exhibitions_num_pages = @exhibitions_needs_paging ? (@exhibitions.total_entries / WillPaginate.per_page.to_f).ceil : 1
