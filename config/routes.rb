Rails.application.routes.draw do
 ...
 # TODO: make this POST
  ...
  get '/quick_search/query_results/:type/:page/:query/:length/:sort' => 'quick_search#query_results', as: 'query_results_with_length_and_sort', constraints: { :query => /[^\/]+/ }
  get '/quick_search/query_results/:type/:page/:query/:length' => 'quick_search#query_results', as: 'query_results_with_length', constraints: { :query => /[^\/]+/ }
